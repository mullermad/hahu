...
<template>
    <div class="h-screen overflow-hidden hidden lg:flex lg:w-1/2 flex-col ">
        <div class="ml-52 space-y-4 ">
            <IconLoginLogo class="" />
            <IconMotoLogin class="ml-10 " />
        </div>
        ...
        <div className="text-white font-roboto  text-center -mt-14">
            <p className="3xl:text-[40px] p-2 lg:text-2xl uppercase font-semibold 2xl:leading-[3.75rem]">
                Your Dream Jobs are Waiting
            </p>
            <div className="w-[50%] mx-auto mt-4  mb-6 border-2 border-b border-white"></div>
            <p className="mx-auto w-[70%] text-lg p-3">
