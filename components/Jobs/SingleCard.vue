    ...
    <div
        ...
        <div class=" px-6 ">
            <div class=" flex justify-between items-center space-x-5 mr-8 px-2 py-5 ml-8">
                <div v-if="job.type"
                    class="bg-primary rounded-full mt-4 2xl:text-md 2xl:px-3 2xl:py-1  text-gray-200 flex  text-sm font-roboto py-0.5 px-2 text-center">
                    <Icon
            ...
            <TabGroup>
                ...
                <TabList class="flex space-x-3  border-b rounded-b-sm border-gray-200">
                    <Tab v-for="category in Object.keys(categories)" as="template" :key="category"
                        v-slot="{ selected }">
                        <button :class="[
                            'w-[20%] rounded-none dark:text-white py-3  text-xs 2xl:text-[1rem]  font-lightbold text-gray-700 leading-5',
                ...
                <TabPanels class=" mt-4">
                    <TabPanel v-for="category in Object.keys(categories)" :key="category" class="">
                        ...
                        <div v-if="category === 'KPI'" class=" rounded">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 px-6 shadow-xl border-none ">

                                <p
                                    class="text-[0.63rem] 2xl:text-[0.85rem]  p-2 dark:text-white text-gray-700 leading-relaxed font-roboto ">
                                ...
                                <p
                                    class="text-[0.63rem] p-2 2xl:text-[0.85rem]  dark:text-white text-gray-700 leading-relaxed font-roboto">
                                    <span class="
                            ...
                            <div
                                class="flex flex-col md:flex-row gap-2 2xl:gap-4 items-center border-none justify-center p-3 mt-5">
                                <div class="dark:bg-[#121a26] bg-white flex flex-col items-center  shadow-lg
                                ...
                                <div class="dark:bg-[#121a26] bg-white flex flex-col items-center  
                                  rounded-lg shadow-lg p-2 xl:p-5 h-48 w-52 2xl:w-60 2xl:h-52 
                                  dark:shadow-green-600 ">
                                    <h2 class="text-[0.7rem] 2xl:text-[0.8rem] p-2 mb-1 font-bold text-primary">
                                ...
                                <div class="dark:bg-[#121a26] bg-white flex flex-col items-center 
                                  rounded-lg shadow-lg p-6 h-48 w-52 2xl:w-60 2xl:h-52
                                  dark:shadow-green-600 ">
                                    <h2 class="text-[0.7rem] 2xl:text-[0.8rem] p-1 mb-2 font-bold text-primary mx-auto">
                                ...
                                <TabGroup>
                                    ...
                                    <TabList class="flex space-x-0.5  p-1">
                                        <Tab v-for="lan in Object.keys(language)" as="template" :key="lan"
                                            v-slot="{ selected }">
                                            <button :class="[
                                                'w-[20%] rounded-none py-3 text-gray-500 dark:text-white font-bold text-[0.7rem] 2xl:text-[1rem] leading-5',
                                                selected ? '  dark:text-white   text-primary underline  border-none outline-none focus:outline-none' : ''
                                            ]">
                                                {{ lan }}
                                            </button>
                                        </Tab>
                                    ...
                                    <TabPanels class="">
                                        <TabPanel v-for="category in Object.keys(language)" :key="category">
                                            ...
                                            <div v-if="category === 'English'" class="p">
                                                <p
                                                    class="text-[0.8rem] 2xl:p-4 2xl:text-[1rem] dark:text-gray-300 pb-6 border-none text-gray-500  font-roboto">
                                                    {{
                                                        job.summary }}</p>
                                            ...
                                            <div v-if="category === 'አማርኛ'" class="   rounded">
                                                ...
                                                <img src="@/assets/img/amharic1.png"
                                                    class=" h-40 w-40 mx-40 2xl:h-60 2xl:w-60 2xl:mx-80  " />
                                            </div>
                                        </TabPanel>
                                    </TabPanels>
                                </TabGroup>
                        ...
                        <div v-if="category === 'Analysis'" class="
                          ">
                            <div class="border border-gray-400 rounded mt-6 p-4 ">
                                ...
                                <div>
                                    <h4
                                        class="font-roboto text-[0.7rem] 2xl:text-[0.9rem] p-2 font-bold mb-3  text-primary">
                                    ...
                                    <p
                                        class="font-roboto text-[0.7rem] 2xl:text-[0.9rem] p-1 font-bold  mb-3 text-blue-500">
                                        Electrical
                                        Mechanics and
                                ...
                                <div class="flex space-x-4 mt-4">
                                    ...
                                    <div class="shadow-lg w-[300px] p-4">
                                        ...
                                        <p
                                            class="text-[0.7rem] 2xl:text-[0.9rem] text-gray-600 dark:text-gray-300 p-2 mb-2">
                                        ...
                                        <p v-if="jobAnalysis.isco_08.parent.excluded_occupations"
                                            class="text-[0.7rem] 2xl:text-[0.9rem]  dark:text-gray-300  text-gray-600 p-2">
                                            {{ jobAnalysis.isco_08.parent.excluded_occupations }}
                                        </p>
                                        <p v-else
                                            class="text-[0.7rem] 2xl:text-[0.9rem]  text-gray-600 dark:text-gray-300  p-2">
                                    ...
                                    <div class="shadow-lg  w-[500px] p-3 pb-8 ">
                                        <h4 class="text-primary text-[0.7rem] 2xl:text-[0.9rem]  font-bold mb-5">
                                            <Icon icon="hugeicons:pyramid-structure-01" class="w-4 h-4 inline mr-1" />
                                            Structure
                                        </h4>
                                        <div class="flex flex-col gap-1">
                                            <p
                                                class="text-[0.7rem] 2xl:text-[0.9rem]  text-gray-700 bg-gray-100 dark:text-white dark:bg-gray-600  rounded-md px-4 py-3 ">
                                            ...
                                            <p
                                                class="text-[0.7rem] 2xl:text-[0.9rem]  text-gray-600 bg-gray-100 dark:text-white dark:bg-gray-600 rounded-md px-4 py-3">
                                                <span class="text-white bg-primary px-2 py-1  text-sm mr-2 font-bold">{{
                                ...
                                <p class="text-[0.7rem] 2xl:text-[0.9rem]  text-gray-500 dark:text-gray-300 m-2 p-4">The
                                    International
                            ...
                            <div class="border rounded mt-10  p-4 ">
                                ...
                                <div>
                                    <h4
                                        class="font-roboto text-[0.7rem] 2xl:text-[0.9rem]  p-2 font-bold mb-1  text-primary">
                                        <Icon icon="mdi:star" class="w-4 h-4 inline mr-1" />Vacancy
                                        Analysis
                                    </h4>
                                    <p
                                        class="font-roboto text-[0.7rem] 2xl:text-[0.9rem]  ml-2 font-bold  text-blue-500">
                                        Electrical
                                        and Electronics Installers and Repairers, Transportation Equipment (49-2093.00)

                                    </p><span
                                        class="text-[0.68rem] 2xl:text-[0.8rem]  ml-2 text-gray-700 dark:text-gray-300">Also
                                        Called:
                                        Body Wirer, Control
                                        Troubleshooter,
                                ...
                                <div class="flex  space-x-2  mt-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="shadow-lg max-h-[250px]   overflow-y-auto p-4  ">
                                            ...
                                            <div v-for="(skill, index) in jobAnalysis.soc_2010.skills" :key="index"
                                                ...
                                                <p
                                                    class="text-[0.6rem] 2xl:text-[0.9rem]  text-gray-600 dark:text-gray-300">
                                                    {{
                                                ...
                                                <div class="relative pt-1">
                                                    ...
                                                    <div class="flex mb-2 items-center justify-between">
                                                        ...
                                                        <div class="w-full bg-gray-200 rounded-full">
                                                            ...
                                                            <div class="bg-primary text-[0.6rem] 2xl:text-[0.9rem]  leading-none py-0.5 2xl:py-0.75 text-center text-white"
                                                        ...
                                                        <span
                                                            class="text-[0.6rem] 2xl:text-[0.8rem]  font-semibold inline-block px-1 uppercase rounded-full text-primary">
                                        ...
                                        <p class="text-xs 2xl:text-[0.9rem] text-primary font-bold  ml-3 mt-4 ">
                                        ...
                                        <div class="shadow-lg max-h-[260px]  overflow-y-auto  p-4">
                                            <div v-for="(tecno, index) in jobAnalysis.soc_2010.technology_skills"
                                                :key="index">
                                                <li
                                                    class="text-[0.76rem] 2xl:text-[0.9rem]   text-gray-700 dark:text-gray-300">
                                                    {{
                                                        tecno.example }}</li>
                                                <p
                                                    class="text-[0.67rem] 2xl:text-[0.8rem] ml-3 2xl:ml-6 p-1 text-gray-500 dark:text-gray-400">
                                                    {{
                                    ...
                                    <div class=" flex-1 ">
                                        <div>
                                            ...
                                            <p class="text-xs  2xl:text-[1rem]  text-primary font-bold ml-3 mt-5">
                                            ...
                                            <div class="shadow-lg max-h-[250px]  overflow-y-auto  p-4  ">
                                                ...
                                                <div v-for="(abilitie, index) in jobAnalysis.soc_2010.abilities"
                                                    ...
                                                    <!-- Display the knowledge name dynamically -->
                                                    <p
                                                        class="text-[0.6rem] 2xl:text-[0.9em]  text-gray-600 dark:text-gray-300">
                                                        {{
                                                    ...
                                                    <div class="relative pt-1">
                                                        ...
                                                        <div class="flex mb-2 items-center justify-between">
                                                            ...
                                                            <div class="w-full bg-gray-200 rounded-full">
                                                                <!-- Green progress bar, dynamically setting the width based on percentage -->
                                                                <div class="bg-primary text-[0.6rem] 2xl:text-[0.8rem]  leading-none py-0.5 2xl:py-0.75 text-center text-white"
                                    ...
                                    <div class=" flex-1 ">
                                        ...
                                        <div class="space-y-2 ">
                                            <div class="h-[230px] p-4">
                                                <h4 class="text-primary text-[0.9rem] 2xl:text-[1rem]  font-bold ml-2">
                                                    What they do:
                                                </h4>
                                                <p
                                                    class="text-[0.7rem] 2xl:text-[0.9rem]  text-gray-500 p-2 dark:text-gray-300 mb-2">
                                            ...
                                            <div class="  p-2">
                                                ...
                                                <div class="shadow-lg max-h-[284px]  overflow-y-auto  p-4">
                                                    <div v-for="(taskkey, index) in jobAnalysis.soc_2010.task_statements"
                                                        ...
                                                        <!-- Display the knowledge name dynamically -->
                                                        <li
                                                            class="text-[0.7rem] 2xl:text-[0.9rem]  text-gray-500 dark:text-gray-300">
                                                            {{
                                                                taskkey.task }}</li>
                            ...
                            <p class="text-xs 2xl:text-[0.9rem] text-primary font-bold m-2 ">Context of our analysis</p>

                            <p class="text-[0.7rem] 2xl:text-[0.9rem] text-gray-500 m-2 p-4 dark:text-gray-300">The
